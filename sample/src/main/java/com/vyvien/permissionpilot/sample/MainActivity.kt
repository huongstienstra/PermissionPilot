...
import com.vyvien.permissionpilot.compose.PermissionGate
import com.vyvien.permissionpilot.compose.PermissionPilotState
import com.vyvien.permissionpilot.compose.rememberPermissionPilotState
...
private fun PermissionLab() {
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .testTag(SampleTestTags.PermissionLab)
            .safeDrawingPadding()
        ...
        FlowRow(
            modifier = Modifier.testTag(SampleTestTags.UseCaseChips),
...
private fun PermissionSummaryCard(state: PermissionPilotState) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .testTag(SampleTestTags.PermissionSummary),
    ) {
        Column(
            modifier = Modifier.padding(16.dp),
            ...
            Text(
                ...
                modifier = Modifier.testTag(SampleTestTags.PermissionSummaryTitle),
            ...
            if (state.requiredPermissions.isEmpty()) {
                Text(
                    ...
                    modifier = Modifier.testTag(SampleTestTags.RequiredPermissions),
                )
            } else {
                Column(modifier = Modifier.testTag(SampleTestTags.RequiredPermissions)) {
...
private fun PermissionActionCard(
    ...
    ElevatedCard(
        modifier = Modifier
            .fillMaxWidth()
            .testTag(SampleTestTags.PermissionAction),
    ) {
        Column(
            modifier = Modifier.padding(16.dp),
...
object SampleTestTags {
    const val PermissionLab = "permission_lab"
    const val UseCaseChips = "use_case_chips"
    const val PermissionSummary = "permission_summary"
    const val PermissionSummaryTitle = "permission_summary_title"
    const val RequiredPermissions = "required_permissions"
    const val PermissionAction = "permission_action"
}
